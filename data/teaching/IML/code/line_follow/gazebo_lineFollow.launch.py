...
def generate_launch_description():
   # main package path
  package_dir=get_package_share_directory('iml_buche')
  # using package path to find urdf file
  urdf = os.path.join(package_dir,'camera_lidar_gazebo.urdf')
  # using package path to find the Custom World file
  world_file=os.path.join(package_dir,'line_world.world')
  # Adding path to gazebo_ros package
  pkg_gazebo_ros = get_package_share_directory('gazebo_ros')
  # Important rviz file to make life easy 
  rviz_config_file=os.path.join(package_dir,'launch_config.rviz')
  ...
  return LaunchDescription([
    ...
    # to spawn the robot we added gazebo_ros spawn entity node
        Node(
            ...
            name='urdf_spawner',
            output='screen',
            arguments=["-topic", "/robot_description", "-entity", "buche_robot"]
            )
  ])
